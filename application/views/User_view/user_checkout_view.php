    ...
    <div>
      ...
      <div>
        <div>
          ...
          <form method="post" action="<?php echo base_url('User_Controller/User_cart_controller/update_cart/'); ?>">
          ...
          <table class="table table-bordered" style="width:1000px;width:">
            ...
            <tbody>
              <tr>
                ...
                <td>
                 <input id="txt_qty[]" name="txt_qty[]"  width:20px; type="text" value="<?php echo $row_product->product_qty; ?>">
                  <input type="hidden" id="txt_id[]" name="txt_id[]" value="<?php echo $row_product->product_id; ?>" ></td>
