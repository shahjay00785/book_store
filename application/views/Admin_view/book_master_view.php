<script language="javascript" type="text/javascript">
	...
	function getsubcategory(category_id)
	{
		...
		var strURL="<?php echo base_url('Ajax_controller/Ajax_controller/getsubcategory/'); ?>"+category_id;
		alert(strURL);
		var req = getXMLHTTP();
    ...
    if (req) {
			...
			req.onreadystatechange = function() {
				if (req.readyState == 4) {
					// only if "OK"
					if (req.status == 200) {
						document.getElementById('txt_select_sub_category').innerHTML=req.responseText;
					} else {
        ...
        <div class="col-lg-6">
          ...
          <form role="form" id="myform" name="myform" method="post" action="<?php echo base_url(); ?>Admin_controller/Admin/manage_book_master/add" enctype="multipart/form-data" class="">
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="txt_select_category" name="txt_select_category" onchange="getsubcategory(this.value)">
        ...
        else
        {
          ...
          <div class="col-lg-6">
            ...
            <form role="form" id="myform" name="myform" method="post" action="<?php echo base_url('Admin_controller/Admin/manage_book_master/do_update/').$row_book_master->book_master_id; ?>" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label>Selects category</label>
                <select class="form-control" id="txt_select_category" name="txt_select_category">
                  <option>---select category----</option>
                  ...
                  <div class="form-group">
                    <label>Selects Sub category</label>
                    <option>--select sub categorty---</option>
                  </select>
                </div>
