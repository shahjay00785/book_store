 ...
 */
$config['public_key']   = 'https://www.google.com/recaptcha/admin/create?app=Codeigniter';
$config['private_key']  = 'https://www.google.com/recaptcha/admin/create?app=Codeigniter';
